...
/// NOTE: Just here temporarily as an example of very direct/efficient ways to use FTC Vision with PP
/// Delete this in a few days or a week, basically, after we've decide how to update the Auton
/// and how it uses Vision and the Pedro Follower.  <-- Class is straight from PP Sample OpModes!
